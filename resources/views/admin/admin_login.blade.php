                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        ...
                                        <button class="btn btn-success float-right" ><input type="submit" value="Login"></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row m-t-20">
                        ...
                        <form class="col-12" action="index.html">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="email" name="email" class="form-control form-control-lg" placeholder="lololo" aria-label="Username" aria-describedby="basic-addon1">
                            </div>
                            <!-- pwd -->
